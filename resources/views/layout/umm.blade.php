...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-dark" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="user/index.html">GOODWILL<br> PAKISTAN</a>
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active"><a href="user/event.html" class="nav-link">MedicalCamps</a></li>
  ...
  <br><br><br>
    ...
    <!--END MAIN CONTENT>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> -->
    <br><br>
		<section class="ftco-section-3 img" style="background-image:  {{URL::to('user/images/bg_3.jpg')}};">
